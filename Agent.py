...
class Agent():
    ...
    def __init__(self, position, destination, color, group):
        ...
        self.velocity = AGENT_VELOCITY*self.direction  # np.array([0.0, 0.0])
    ...
    def calc_goal_force(self):
        ...
        goal_force = (self.desired_velocity *
                      preferred_direction-self.velocity)/TAU
        return goal_force
    ...
    def calc_group_attraction_force(self):
        ...
        return F_G_ATTRACTION*q*normalize(distance_to_center)
